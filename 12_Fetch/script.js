...
//     url: 'https://www.omdbapi.com/?apikey=294c8cf6&s=' + $('.input-keyword').val(),
...
//         $.ajax({
//           url: 'https://www.omdbapi.com/?apikey=294c8cf6&i=' + $(this).data('imdbid'),
//           success: m => {
...
fetch('https://www.omdbapi.com/?apikey=294c8cf6&s=' + inputKeyword.value)
...
modalDetailButton.forEach(btn => {
 btn.addEventListener('click', function() {
  ...
  fetch('https://www.omdbapi.com/?apikey=294c8cf6&i=' + imdbid)
    .then(response => response.json())
    .then(m => {
      const movieDetail = showMovieDetail(m);
